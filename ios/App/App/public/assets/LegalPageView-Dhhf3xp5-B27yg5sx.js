import{K as _,d as j,m as o,i as e,l as u,W as w,bN as N}from"./index-C5plmM0D.js";const S=({pageId:a,onBack:p})=>{var s,l,c,d;const{language:r}=_(),{getLegalPages:m}=j(),[t,h]=o.useState(null),[g,y]=o.useState(!0);if(o.useEffect(()=>{async function b(){try{const i=(await m()).find(f=>f.id===a);i&&h(i)}catch(i){console.error("Failed to load legal page:",i)}finally{y(!1)}}b()},[a,m]),g)return e.jsx("div",{className:"min-h-screen flex items-center justify-center bg-slate-50",children:e.jsx("div",{className:"animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-primary"})});const n={terms:{title_ar:"الشروط والأحكام",title_en:"Terms & Conditions",content_ar:`أهلاً بكم في متجر شركة نجوم دلتا للتجارة. باستخدامكم لهذا الموقع، فإنكم توافقون على الالتزام بالشروط التالية:
...
3. Fleet: We use a refrigerated fleet with international cooling standards.`}},x=r==="ar"?(t==null?void 0:t.title_ar)||((s=n[a])==null?void 0:s.title_ar):(t==null?void 0:t.title_en)||((l=n[a])==null?void 0:l.title_en),v=r==="ar"?(t==null?void 0:t.content_ar)||((c=n[a])==null?void 0:c.content_ar):(t==null?void 0:t.content_en)||((d=n[a])==null?void 0:d.content_en);return e.jsx("div",{className:"min-h-screen bg-slate-50 pt-24 pb-12 font-tajawal",dir:r==="ar"?"rtl":"ltr",children:e.jsxs("div",{className:"container mx-auto px-6 max-w-4xl",children:[e.jsxs(u.button,{initial:{opacity:0,x:-10},animate:{opacity:1,x:0},onClick:p,className:"mb-8 flex items-center gap-2 text-primary font-bold hover:gap-4 transition-all",children:[e.jsx(w,{className:`w-5 h-5 ${r==="ar"?"rotate-180":""}`}),r==="ar"?"العودة للرئيسية":"Back to Home"]}),e.jsxs(u.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"bg-white p-10 md:p-16 rounded-[3rem] shadow-xl border border-gray-100",children:[e.jsxs("div",{className:"flex items-center gap-6 mb-10 border-b border-gray-100 pb-10",children:[e.jsx("div",{className:"w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center text-primary",children:e.jsx(N,{className:"w-8 h-8"})}),e.jsxs("div",{children:[e.jsx("h1",{className:"text-4xl font-black text-slate-900",children:x||"Legal Page"}),e.jsx("p",{className:"text-gray-400 font-bold uppercase tracking-widest text-xs mt-1",children:"Delta Stars Sovereign Policies"})]})]}),e.jsx("div",{className:"prose prose-lg max-w-none text-slate-700 leading-relaxed whitespace-pre-wrap font-medium",children:v||(r==="ar"?"المحتوى غير متوفر حالياً.":"Content is not available currently.")})]})]})})};export{S as LegalPageView};
